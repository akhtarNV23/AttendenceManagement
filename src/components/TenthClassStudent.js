...
class TenthClassStudent extends Component {
  state = {
    students: [],
    newStudentName: "",
    newStudentEmail: "",
  ...
  render() {
    const { isModal, studentId, isDelete} = this.state;
...
export default connect(mapStateToProps, mapDispatchToProps)(TenthClassStudent);
